...
async function main() {
  ...
  const course = await db.course.upsert({
    ...
    update: {
      ...
      description: "K2 Coaching HTG đi từ thực trạng của nhà đầu tư Việt Nam, giải mã di sản và công thức vận hành chiến lược Warren Buffett, đến Hệ thống Đầu tư Tỉnh thức HTG với ba tầng TÂM — TẦM — THẾ. Khóa học giúp học viên xây dựng chiến lược phù hợp cho từng giai đoạn tiền đắt, tiền rẻ; nhận diện sai lầm trong quản trị danh mục, cảm xúc và đòn bẩy; đồng thời hiểu nguyên tắc xây dựng danh mục chủ lực HTG 2026–2030.\n\nTỉnh thức trước đám đông — Sáng suốt cùng giá trị. Nội dung phục vụ mục đích giáo dục, không phải khuyến nghị mua bán hay cam kết lợi nhuận.",
      targetAudience: "Nhà đầu tư cá nhân muốn xây dựng phương pháp đầu tư có hệ thống; người cần hiểu sâu triết lý Warren Buffett trong bối cảnh Việt Nam; nhà đầu tư muốn nâng cao năng lực phân tích chu kỳ, quản trị vốn, danh mục và tâm lý giao dịch giai đoạn 2026–2030.",
