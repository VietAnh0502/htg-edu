...
const contentBySlug: Record<string, CourseContent> = {
  "coaching-htg-danh-song-k1-2026": { videoEmbedUrl: "https://www.youtube-nocookie.com/embed/0-fbTLpcIgk?rel=0&fs=1&playsinline=0&vq=hd2160", youtubeUrl: "https://www.youtube.com/live/0-fbTLpcIgk", pdfFileName: "k1-course-material.pdf" },
  "k2-coaching-htg-2026": { videoEmbedUrl: "https://www.youtube-nocookie.com/embed/Yj8J-QZm2aY?rel=0&fs=1&playsinline=0&vq=hd2160", youtubeUrl: "https://www.youtube.com/live/Yj8J-QZm2aY", pdfFileName: "k2-course-material.pdf" },
